...
class NotificationResourceIT {
    ...
    private static final NotificationStatus UPDATED_STATUS = NotificationStatus.SEND;

    private static final NotificationType DEFAULT_TYPE = NotificationType.SYSTEM;
    ...
    void getAllNotificationsBySenderIsEqualToSomething() throws Exception {
        ...
        // Get all the notificationList where sender equals to
        defaultNotificationFiltering("sender.equals=" + DEFAULT_SENDER, "sender.equals=" + UPDATED_SENDER);
    }
    ...
    void getAllNotificationsBySenderIsInShouldWork() throws Exception {
        ...
        // Get all the notificationList where sender in
        defaultNotificationFiltering("sender.in=" + DEFAULT_SENDER + "," + UPDATED_SENDER, "sender.in=" + UPDATED_SENDER);
    }
    ...
    void getAllNotificationsBySenderIsNullOrNotNull() throws Exception {
        ...
        defaultNotificationFiltering("sender.specified=true", "sender.specified=false");
    }
    ...
    void getAllNotificationsBySenderContainsSomething() throws Exception {
        ...
        // Get all the notificationList where sender contains
        defaultNotificationFiltering("sender.contains=" + DEFAULT_SENDER, "sender.contains=" + UPDATED_SENDER);
    }
    ...
    void getAllNotificationsBySenderNotContainsSomething() throws Exception {
        ...
        // Get all the notificationList where sender does not contain
        defaultNotificationFiltering("sender.doesNotContain=" + UPDATED_SENDER, "sender.doesNotContain=" + DEFAULT_SENDER);
    }
    ...
    void partialUpdateNotificationWithPatch() throws Exception {
        ...
        partialUpdatedNotification.sender(UPDATED_SENDER).recipient(UPDATED_RECIPIENT).message(UPDATED_MESSAGE).link(UPDATED_LINK);
